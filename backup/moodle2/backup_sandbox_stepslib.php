...
class backup_sandbox_activity_structure_step extends backup_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        $sandbox->annotate_files('mod_sandbox', 'intro', null);

        // Return the root element (sandbox), wrapped into standard activity structure.
        return $this->prepare_activity_structure($sandbox);
    }
}
